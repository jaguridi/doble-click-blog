...
layout: lectura
numero: 14
tags: [trabajo, mercados, gobernanza]
title: "Estar expuesto a la IA no es lo mismo que estar en riesgo de perder el empleo"
description: "OpenAI cruzó más de 900 ocupaciones con tres preguntas y estimó que solo un 18% de los empleos en Estados Unidos corre riesgo alto de automatización en el corto plazo; el resto se reorganiza, crece o cambia poco. Su tesis: la 'exposición' a la IA, por sí sola, no dice dónde va a doler."
date: 2026-07-20
paper_titulo: "The AI Jobs Transition Framework: Mapping AI's Near-Term Impact on Jobs"
paper_autores: "Richmond"
paper_publicado: "OpenAI, abril 2026"
paper_doi: "https://openai.com/index/modeling-ai-jobs-transition/"
paper_keywords: "AI exposure, human necessity, demand elasticity, labor market transition, occupational automation"
paper_archivo: "openai-2026-ai-jobs-transition-framework.pdf"
audio: true
---
...
- **Quiénes:** [Alex Martin Richmond](https://scholar.google.com/scholar?q=%22Alex+Martin+Richmond%22+OpenAI), economista de OpenAI, con un prólogo de [Ronnie Chatterji](https://scholar.google.com/scholar?q=Ronnie+Chatterji), economista jefe de la empresa.
- **Dónde:** publicado por OpenAI Economic Research en abril de 2026. No es un paper con revisión de pares ni tiene DOI: es un reporte de la propia empresa. [openai.com/index/modeling-ai-jobs-transition](https://openai.com/index/modeling-ai-jobs-transition/)
...
Y hay una razón de fondo para leerlo con pinzas desde acá, que es la parte que no conviene omitir. Es un documento de OpenAI que mide el impacto de la IA usando el uso de su propio producto y estimando dos de sus tres capas con sus propios modelos. Eso no invalida los datos, pero sí lo vuelve evidencia interna y no auditoría independiente. La empresa tiene interés en que la historia salga en clave de transición manejable y no de ola de despidos, y esa elección de encuadre no es neutral. Antes de que un ministerio de la región lo cite para justificar una política, conviene pedir lo que el propio reporte reconoce que no tiene: mediciones locales y evidencia de resultados en el mundo real.
