...
- **Quiénes:** dieciocho personas de Google y Google DeepMind. La correspondencia queda a nombre de Zanna Iscenko y Scott Strand. Los agradecimientos consignan contribuciones, orientación y revisión de Diane Coyle (Universidad de Cambridge) y David Autor (MIT).
- **Dónde:** publicado por Google el 23 de julio de 2026. No tiene DOI ni revisión por pares: es un reporte de la propia empresa sobre su propio producto.
...
- Mide comportamiento, no resultados. Que una conversación termine no significa que la persona haya logrado su objetivo ni ahorrado tiempo. Los autores lo enuncian como su primera limitación.
