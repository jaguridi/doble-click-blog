...
- **[Claude Opus 4.8 llega con orquestación de subagentes y control de esfuerzo](https://www.anthropic.com/news/claude-opus-4-8)** — El nuevo modelo de Anthropic, anunciado el mismo día que la ronda, promete coordinar muchas tareas en paralelo y reducir de forma notable la "sobreconfianza" al reportar resultados erróneos.
- **[Demis Hassabis en Stanford: la IA es una "transición a nivel de especie"](https://stanforddaily.com/2026/05/29/deepmind-ceo-warns-about-ai/)** — El CEO de Google DeepMind y Nobel de Química adelantó su pronóstico de inteligencia artificial general a 2029 y pidió coordinación internacional en los próximos 5 a 10 años. Es el tercer líder de un laboratorio de frontera en dos semanas en usar lenguaje de urgencia.
- **[Caída global de ChatGPT: API, DALL-E, Codex, Sora y el login afectados](https://www.businessupturn.com/technology/chatgpt-down-openai-users-report-widespread-problems-with-api-app-and-login-on-may-29)** — Un apagón masivo dejó fuera de servicio a buena parte de las herramientas de OpenAI, con errores de "demasiadas conexiones concurrentes" y sin causa oficial confirmada. Un recordatorio de la fragilidad de una infraestructura de la que ya dependen empresas y gobiernos.

## En la región

La gran historia regional del día es la democracia bajo presión digital. **Colombia** celebra elecciones presidenciales el 31 de mayo sin ningún marco regulatorio de IA electoral, justo la semana posterior a que Brasil aprobara su ley de inteligencia artificial. La Misión de Observación Electoral [advierte](https://moe.org.co/moe-advierte-sobre-incremento-en-riesgos-por-violencia-y-desinformacion-y-retrasos-en-financiacion-electoral-de-cara-al-31-de-mayo/) que el desafío central ya no es la alteración física del voto, sino el engaño sistemático al votante mediante clonación de voz y videos hiperrealistas que circulan por WhatsApp y redes. En paralelo, **Bolivia** acumula [29 contenidos falsos generados con IA](https://boliviaverifica.bo/falso-video-viral-reutiliza-audio-generado-con-ia-para-afirmar-que-rodrigo-paz-renuncio/) del presidente Rodrigo Paz desde el 12 de mayo —entre ellos un audio clonado que anunciaba una falsa renuncia—, también sin legislación específica contra los deepfakes. Es la primera vez que dos países de la región enfrentan simultáneamente una alerta por desinformación con IA en plena coyuntura política. Para quienes quieran incidir desde fuera de los grandes bloques, hay una ventana concreta: la consulta pública de la Ley de IA de la Unión Europea sobre clasificación de sistemas de alto riesgo está abierta hasta el 23 de junio.

## Lanzamientos

- **[Claude Opus 4.8](https://www.anthropic.com/news/claude-opus-4-8)** — Modelo orientado a tareas autónomas con dos novedades: "Dynamic Workflows", que permite coordinar muchos subagentes en paralelo dentro de una misma sesión, y "Effort Control", que regula cuánto razonamiento dedica el modelo a cada tarea. Mantiene el precio de la versión anterior y está disponible desde el primer día en claude.ai, la API y GitHub Copilot, lo que amplía su alcance para equipos de desarrollo de la región.
